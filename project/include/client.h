...
namespace ECProject
{
  ...
  public:
    ...
    void get_rs_block_num_per_group_srs_ers(int k, int r, std::vector<int> &data_block_num_per_group, std::vector<int> &global_parity_block_num_per_group, std::vector<int> &local_parity_block_num_per_group);
