...
namespace ECProject
{
  ...
  public:
    ...
    void get_cluster_rt_block_num_per_group_from_stripe_id(int k, int r, int z, int stripe_id, std::vector<int> &data_block_num_per_group, std::vector<int> &global_parity_block_num_per_group, std::vector<int> &local_parity_block_num_per_group);
