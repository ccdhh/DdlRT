...
namespace ECProject
{
  ...
  void Config::validateConfig() const
  {
    ...
    assert((AppendMode == "REP_MODE" || AppendMode == "UNILRC_MODE" || AppendMode == "CACHED_MODE" || AppendMode == "EQUIOX_MODE"|| AppendMode == "SRS&ERS") && "Error: AppendMode must be REP_MODE, UNILRC_MODE, or CACHED_MODE");
